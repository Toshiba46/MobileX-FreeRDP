...
gcc -I$JAVA_DIR/include -I$JAVA_DIR/include/linux $XRDP_INCLUDES -I"../../Downloads/FreeRDP/include" -I"jni" -I"jni/generated" -o bin/libRDPServer.so -shared jni/mobilex_rdpserver.c jni/mobilex_rdpserver.h jni/generated/mobilex_rdpserver_jni.c $XRDP_SOURCES bin/libcommon.a bin/libxrdp.a -lcrypto -lssl -lpthread
